...
function LoginForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-secondary">
            <div className="w-full max-w-md p-8 space-y-8 glass rounded-lg animate-fade-in">
                {/* Logo */}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Login safely with your Discord account
                            </p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Configure bot settings for all your servers
                            </p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Access moderation, economy, leveling, and more
                            </p>
                        </div>
                    </div>
                </div>
